            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="perusahaan" id="perusahaan" class="form-control" value="{{ old('perusahaan', $supplier->perusahaan) }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" id="phone" class="form-control" value="{{ old('phone', $supplier->phone) }}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('suppliers.index') }}" class="btn btn-sm btn-outline-secondary mr-2">BATAL</a>
