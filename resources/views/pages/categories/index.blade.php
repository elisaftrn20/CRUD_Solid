...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 style="font-size: 24px; font-weight: bold; color: #2C3E50;">Kategori</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right" style="background: none; padding: 0; font-size: 14px;">
            ...
            <li class="breadcrumb-item active" style="color: #7f8c8d;">Kategori</li>
        </ol>
    </div>
</div>
@endsection
                        ...
                        <tr style="background: #f8f9fa;">
                            ...
                            <td style="text-align: center; padding: 10px;">
                                <div class="d-flex justify-content-center">
                                    <a href="/categories/edit/{{ $category->id }}" class="btn btn-sm mr-2" 
                                       style="background: #f39c12; color: white; border: none; padding: 6px 12px; border-radius: 5px; transition: 0.3s;">
                                        Edit
                                    </a>
                                    <button onclick="confirmDelete({{ $category->id }})" class="btn btn-sm"
